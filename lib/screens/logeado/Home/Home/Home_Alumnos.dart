...
class Home_Alumno extends StatefulWidget {
  const Home_Alumno({super.key, required int userT5});

  @override
  State<Home_Alumno> createState() => _Home_AlumnoState();
}

class _Home_AlumnoState extends State<Home_Alumno> {
  //
  String tipoUsuario = '';
  int T5 = 0;
    ...
    return Scaffold(
        ...
        body: Container(
            ...
            child: Stack(children: [
              ...
              Column(children: [
                const SizedBox(height: 25), // Ya no me funciona la busqueda
                Container(
